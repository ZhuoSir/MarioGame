...
import com.chen.sonar.sample.SonarSample;
...
//            songs[4] = MidiSystem.getSequence(Art.class.getResourceAsStream("/mus/smwtitle.mid"));
            ...
            songs[0] = MidiSystem.getSequence(FileUtils.getRsourceAsStream("/mus/smb3map1.mid"));
            songs[1] = MidiSystem.getSequence(FileUtils.getRsourceAsStream("/mus/smwovr1.mid"));
            songs[2] = MidiSystem.getSequence(FileUtils.getRsourceAsStream("/mus/smb3undr.mid"));
            songs[3] = MidiSystem.getSequence(FileUtils.getRsourceAsStream("/mus/smwfortress.mid"));
            songs[4] = MidiSystem.getSequence(FileUtils.getRsourceAsStream("/mus/smwtitle.mid"));
        }
        catch (Exception e)
        {
            sequencer = null;
...
//        BufferedImage source = ImageIO.read(Art.class.getResourceAsStream(imageName));
        BufferedImage source = ImageIO.read(FileUtils.getRsourceAsStream(imageName));
